define(['pipAPI','https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.2.1/IAT/iat6.js?' + Math.random()], function(APIConstructor, iatExtension){
    ...
    return iatExtension({
        ...
        category2 : {
            name : global.disableLabel, //Will appear in the data.
            title : {
                media : {word : global.disableLabel}, //Name of the category presented in the task.
                css : {color:'#31940F','font-size':'1.8em'}, //Style of the category title.
            ...
            //Stimulus css (style)
            // stimulusCss : {color:'#31940F','font-size':'2.4em'}
        },
        attribute1 : {
            name : 'Bad',
            title : {
                media : {word : 'Bad'},
                css : {color:'#0000FF','font-size':'1.8em','margin-bottom','5em'},
                height : 4 //Used to position the "Or" in the combined block.
            },
            stimulusMedia : [ //Stimuli content as PIP's media objects
