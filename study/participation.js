define(['questAPI'], function(Quest){
    ...
    API.addQuestionsSet({
      email: [{
        ...
        errorMsg: {
            required: "To claim credit you must enter your email address.",
      ...
      first_name: [{
        ...
        errorMsg: {
            required: "To claim credit you must enter your first name.",
        },
        required: true,
      }],
      ...
      last_name: [{
        ...
        errorMsg: {
            required: "To claim credit you must enter your last name.",
        },
        required: true,
